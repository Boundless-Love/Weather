package com.showly.ylin.signcalendardemo.signcalendar;
...
import com.showly.ylin.signcalendardemo.R;
...
public class SignCalendar extends ViewFlipper implements GestureDetector.OnGestureListener {
    ...
    private Map<String, Integer> marksMap = new HashMap<>(); // 储存某个日子被标注(Integer为bitmap res id)
